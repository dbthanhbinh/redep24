...
class tie_social_widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			...
			'description' => 'My Widget is social-icons-widget',
		);
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'social-icons-widget' );
		parent::__construct( 'social-icons-widget', theme_name .' - Ads 250*350', $widget_ops, $control_ops );
	}
