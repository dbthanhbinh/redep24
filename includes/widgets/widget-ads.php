<?php
	...
	class ads125_widget extends WP_Widget {
		...
		// 	parent::WP_Widget( 'ads125-widget',theme_name .' - Ads 125*125', $widget_ops, $control_ops );
		// }
		/**
		...
		public function __construct() {
			$widget_ops = array( 
				...
				'description' => 'My Widget is ads125-widget',
			);
			$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'ads125-widget' );
			parent::__construct( 'ads125-widget', theme_name .' - Ads 125*125', $widget_ops, $control_ops );
		}
	...
	class ads120_90_widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops = array( 
				'classname' => 'ads120_90-widget',
				'description' => 'My Widget is ads120_90-widget',
			);
			$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'ads120_90-widget' );
			parent::__construct( 'ads120_90-widget', theme_name .' - Ads 120*90', $widget_ops, $control_ops );
		}
	...
	class ads120_60_widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops = array( 
				'classname' => 'ads120_60-widget',
				'description' => 'My Widget is ads120_60-widget',
			);
			$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'ads120_60-widget' );
			parent::__construct( 'ads120_60-widget', theme_name .' - Ads 120*60', $widget_ops, $control_ops );
		}
	...
	class ads120_600_widget extends WP_Widget {	
		public function __construct() {
			$widget_ops = array( 
				'classname' => 'ads120_600-widget',
				'description' => 'My Widget is ads120_600-widget',
			);
			$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'ads120_600-widget' );
			parent::__construct( 'ads120_600-widget', theme_name .' - Ads 120*600', $widget_ops, $control_ops );
		}
	...
	class ads120_240_widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops = array( 
				'classname' => 'ads120_240-widget',
				'description' => 'My Widget is ads120_240-widget',
			);
			$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'ads120_240-widget' );
			parent::__construct( 'ads120_240-widget', theme_name .' - Ads 120*240', $widget_ops, $control_ops );
		}
	...
	class ads160_600_widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops = array( 
				'classname' => 'ads160_600-widget',
				'description' => 'My Widget is ads160_600-widget',
			);
			$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'ads160_600-widget' );
			parent::__construct( 'ads160_600-widget', theme_name .' - Ads 160*600', $widget_ops, $control_ops );
		}
	...
	class ads300_600_widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops = array( 
				'classname' => 'ads300_600-widget',
				'description' => 'My Widget is ads300_600-widget',
			);
			$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'ads300_600-widget' );
			parent::__construct( 'ads300_600-widget', theme_name .' - Ads 300*600', $widget_ops, $control_ops );
		}
	...
	class ads250_250_widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops = array( 
				'classname' => 'ads250_250-widget',
				'description' => 'My Widget is ads250_250-widget',
			);
			$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'ads250_250-widget' );
			parent::__construct( 'ads250_250-widget', theme_name .' - Ads 250*250', $widget_ops, $control_ops );
		}
	...
	class ads300_100_widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops = array( 
				'classname' => 'ads300_100-widget',
				'description' => 'My Widget is ads300_100-widget',
			);
			$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'ads300_100-widget' );
			parent::__construct( 'ads300_100-widget', theme_name .' - Ads 250*100', $widget_ops, $control_ops );
		}
	...
	class ads300_250_widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops = array( 
				'classname' => 'ads300_250-widget',
				'description' => 'My Widget is ads300_250-widget',
			);
			$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'ads300_250-widget' );
			parent::__construct( 'ads300_250-widget', theme_name .' - Ads 250*350', $widget_ops, $control_ops );
		}
