...
// image Uploader Functions
	...
	tie_set_uploader("logo_retina");
        tie_set_uploader("cat_big_image");
	...
	tie_set_uploader("banner_below_img");
        tie_set_uploader("home_banner_right_slider_img1");        
        tie_set_uploader("home_banner_right_slider_img2"); 
        tie_set_uploader("home_banner_right_slider_img3"); 
        tie_set_uploader("logo_register_footer");         
...
// HomeBuilder
	...
	jQuery("#add-recent").click(function() {
		jQuery('#cat_sortable').append('<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head">  Recent Posts  <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div style="display:block" class="widget-content"><label><span style="float:left;">Exclude This Categories : </span><select multiple="multiple" name="tie_home_cats['+ nextCell +'][exclude][]" id="tie_home_cats['+ nextCell +'][exclude][]">'+htm1l+'</select></label><label for="tie_home_cats['+ nextCell +'][title]"><span>Box Title :</span><input id="tie_home_cats['+ nextCell +'][title]" name="tie_home_cats['+ nextCell +'][title]" value="Recent Posts" type="text" /></label><label for="tie_home_cats['+ nextCell +'][title_images]"><span>Box Title Img Logo Url:</span><input id="tie_home_cats['+ nextCell +'][title_images]" name="tie_home_cats['+ nextCell +'][title_images]" value="" type="text" /></label><label for="tie_home_cats['+ nextCell +'][title_bigimages]"><span>Custom Big Image Url (300x410px):</span><input id="tie_home_cats['+ nextCell +'][title_bigimages]" name="tie_home_cats['+ nextCell +'][title_bigimages]" value="" type="text" /></label><label for="tie_home_cats['+ nextCell +'][title_bigimages_show]"><span>Custom Big Image Url Show:</span><select id="tie_home_cats['+ nextCell +'][title_bigimages_show]" name="tie_home_cats['+ nextCell +'][title_bigimages_show]"><option value="y">Yes</option><option value="n">No</option></select></label><label for="tie_home_cats['+ nextCell +'][title_bigimages_pos]"><span>Custom Big Image Position:</span><select id="tie_home_cats['+ nextCell +'][title_bigimages_pos]" name="tie_home_cats['+ nextCell +'][title_bigimages_pos]"><option value="right">Right</option><option value="left">Left</option></select></label><label for="tie_home_cats['+ nextCell +'][title_img]"><span>Show Title images or text:</span><select id="tie_home_cats['+ nextCell +'][title_img]" name="tie_home_cats['+ nextCell +'][title_img]"><option value="n">No</option><option value="y">Yes</option></select></label><label for="tie_home_cats['+ nextCell +'][title_style]"><span>Show Title style color:</span><select id="tie_home_cats['+ nextCell +'][title_style]" name="tie_home_cats['+ nextCell +'][title_style]"><option value="title_product1">Title style color product1</option><option value="title_product2">Title style color product2</option><option value="title_product3">Title style color product3</option><option value="title_product4">Title style color product4</option><option value="title_product5">Title style color product5</option></select></label> <label for="tie_home_cats['+ nextCell +'][title_url]"><span>Box Title Url :</span><input id="tie_home_cats['+ nextCell +'][title_url]" name="tie_home_cats['+ nextCell +'][title_url]" value="" type="text" /></label><label for="tie_home_cats['+ nextCell +'][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats['+ nextCell +'][number]" name="tie_home_cats['+ nextCell +'][number]" value="10" type="text" /></label><label for="tie_home_cats['+ nextCell +'][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats['+ nextCell +'][offset]" name="tie_home_cats['+ nextCell +'][offset]" value="" type="text" /></label><label for="tie_home_cats['+ nextCell +'][display]"><span>Display Mode:</span><select id="tie_home_cats['+ nextCell +'][display]" name="tie_home_cats['+ nextCell +'][display]"><option value="default">Default Style</option><option value="blog">Blog Style</option></select></label><label for="tie_home_cats['+ nextCell +'][pagi]"><span>Show Pagination:</span><select id="tie_home_cats['+ nextCell +'][pagi]" name="tie_home_cats['+ nextCell +'][pagi]"><option value="n" selected="selected">No</option><option value="y">Yes</option></select></label><p class="tie_message_hint">WordPress WARNING: Setting the offset option breaks pagination, set pagination option to "NO" if you want to use the offset option.</p><input id="tie_home_cats['+ nextCell +'][boxid]" name="tie_home_cats['+ nextCell +'][boxid]" value="recent_'+ 1 + Math.floor(Math.random() * 1500)+'" type="hidden" /><input id="tie_home_cats['+ nextCell +'][type]" name="tie_home_cats['+ nextCell +'][type]" value="recent" type="hidden" /><a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
		nextCell ++ ;
	});
