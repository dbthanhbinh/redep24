			...
			<?php
				...
				tie_cat_options(
					array(	"name" => "Custom Logo Image",
							...
							"cat" => $t_id ,
							"type" => "upload",
                                                        "extra_text" => 'Please Upload Custom cat Logo Image Size: 410x100px'));
                                tie_cat_options(
					array(	"name" => "Custom Cat Big Image",
							"id" => "cat_big_image",
							"cat" => $t_id ,
							"type" => "upload",
                                                        "extra_text" => 'Please Upload Custom Cat Big Image Size: 300x413px')); 
