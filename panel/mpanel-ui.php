...
<div class="mo-panel">
	...
	<div class="mo-panel-tabs">
		...
		<ul>
			...
			<li class="tie-tabs shopsetting"><a href="#tab15"><span></span>Shop Setting</a></li>
                        <li class="tie-tabs newslettersetting"><a href="#tab16"><span></span>Newsletter Setting</a></li>
                        <li class="tie-tabs mobilesetting"><a href="#tab17"><span></span>Mobile Setting</a></li>
                        <!--
			...
			<li class="tie-tabs tie-more tie-not-tab"><a target="_blank" href="http://themeforest.net/user/tielabs/portfolio?ref=tielabs"><span></span>TieLabs Portfolio</a></li>
                        -->    
		</ul>
		<div class="clear"></div>
	</div> <!-- .mo-panel-tabs -->
	...
	<form action="/" name="tie_form" id="tie_form">
		<div id="tab1" class="tabs-wrap">
			...
			<div class="tiepanel-item">
				...
				<?php
					tie_options(
						array(	"name" => "Custom Slogan 1",
								"id" => "slogan1",
								"type" => "text"));
                                        tie_options(
						array(	"name" => "Custom Slogan 2",
								"id" => "slogan2",
								"type" => "text"));
				?>
			...
			<div class="tiepanel-item">
				<h3>Header Setting</h3>
                                <?php					
                                    tie_options(
                                           array(	"name" => "Show Top Menu User Member",
                                                   "id" => "top_menu_member",
                                                   "type" => "checkbox"));
					
				?>
                                <h4 style="padding:5px; padding-left: 10px; margin-left: 2%;">Header code</h4>
			...
			<div class="tiepanel-item">
				...
				<div class="option-item">
                                        <?php 
                                        tie_options(
                                               array(	"name" => "Show Footer Partner",
                                                       "id" => "show_partner",
                                                       "type" => "checkbox"));
                                        ?>
                                    
                                        <br/><h4 style="padding:5px; padding-left: 10px;">Footer Note</h4>
					...
					<textarea id="footer_code" name="tie_options[footer_code]" style="width:100%" rows="7"><?php echo htmlspecialchars_decode(tie_get_option('footer_code'));  ?></textarea>				
                        ...
                        <div class="tiepanel-item">
				<h3>Note Shop info Single products</h3>
				<div class="option-item">
                                        <?php
                                        
                                        tie_options(
						array(	"name" => "Shop Infomation Display ",
								"id" => "note_shop_info",
								"type" => "checkbox"));
                                        
                                        tie_options(
						array(	"name" => "Note Shop Display ",
								"id" => "note_shop_display",
								"type" => "checkbox"));
                                        
                                        tie_options(
						array(	"name" => "Note Shop Vip ",
								"id" => "note_shop_vip",
								"type" => "checkbox"));
                                        
                                        ?>
                                        <h4 style="padding:5px; padding-left: 2%;"> Note shop </h4>
					<small>Note shop for all single page</small>
                                        <?php $default = 'Chợ mua sắm lavadep.com không chịu trách nhiệm về chất lượng sản phẩm này.';?>    
					<textarea id="note_shop" name="tie_options[note_shop]" style="width:100%" rows="7"><?php echo htmlspecialchars_decode(tie_get_option('note_shop')?tie_get_option('note_shop'):$default);  ?></textarea>				
				</div>
			</div>
                        
                        <div class="tiepanel-item">
				<h3>Company Contact infomation</h3>
				<div class="option-item">
                                        <?php 
                                        tie_options(
                                        ...
                                        tie_options(
                                               array(	"name" => "Company email contact",
                                                       "id" => "company_email",
                                                       "type" => "text"));
                                        tie_options(
                                        ...
                                        tie_options(
                                               array(	"name" => "Company Open house",
                                                       "id" => "company_open",
                                                       "type" => "text",
                                                       "extra_text" => 'Ex: 8:00 Am ~ 17:00 PM'
                                                   ));
                        ...
                        <div class="tiepanel-item">
				<h3>Post Color Setting</h3>
				<div class="option-item">
                                        <?php 
                                        tie_options(
                                               array(	"name" => "List Color Setting",
                                                       "id" => "color_setting",
                                                       "type" => "text",
                                                       "extra_text" => 'List color format (Ex:Green,Red,Yellow,Pink... )'
                                                   ));
                        ...
                        <div class="tiepanel-item">
				<h3>Post Size Setting</h3>
				<div class="option-item">
                                        <?php 
                                        tie_options(
                                               array(  "name" => "List Size Setting",
                                                       "id" => "size_setting",
                                                       "type" => "text",
                                                       "extra_text" => 'List Size format (Ex:X,L,M,S... )'
                                                   ));
							...
							if($cats){
								...
								<?php 
									elseif( $cat['type'] == 'recent' ) :	?>
										...
										<div class="widget-content">
											<label><span style="float:left;">Exclude This Categories : </span>
											...
											<label for="tie_home_cats[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats[<?php echo $i ?>][title]" name="tie_home_cats[<?php echo $i ?>][title]" value="<?php   if( !empty($cat['title']) ) echo $cat['title']  ?>" type="text" /></label>
                                                                                        <label for="tie_home_cats[<?php echo $i ?>][title_images]"><span>Box Title Img Logo Url:</span><input id="tie_home_cats[<?php echo $i ?>][title_images]" name="tie_home_cats[<?php echo $i ?>][title_images]" value="<?php   if( !empty($cat['title_images']) ) echo $cat['title_images']  ?>" type="text" /></label>
                                                                                        <label for="tie_home_cats[<?php echo $i ?>][title_bigimages]"><span>Custom Big Image Url (300x410px):</span><input id="tie_home_cats[<?php echo $i ?>][title_bigimages]" name="tie_home_cats[<?php echo $i ?>][title_bigimages]" value="<?php   if( !empty($cat['title_bigimages']) ) echo $cat['title_bigimages']  ?>" type="text" /></label>
                                                                                        <label for="tie_home_cats[<?php echo $i ?>][title_bigimages]"><span>Custom Big Image Show:</span>
                                                                                            <select id="tie_home_cats[<?php echo $i ?>][title_bigimages_show]" name="tie_home_cats[<?php echo $i ?>][title_bigimages_show]">
                                                                                                <option value="y" <?php if ( $cat['title_bigimages_show'] == 'y') { echo ' selected="selected"' ; } ?>>Yes</option>    
                                                                                                <option value="n" <?php if ( $cat['title_bigimages_show'] == 'n') { echo ' selected="selected"' ; } ?>>No</option>                                                                                                    
                                                                                            </select>                                                                                            
                                                                                        </label>
                                                                                        <label for="tie_home_cats[<?php echo $i ?>][title_bigimages_pos]"><span>Custom Big Image Position:</span>                                                                                           
                                                                                            <select id="tie_home_cats[<?php echo $i ?>][title_bigimages_pos]" name="tie_home_cats[<?php echo $i ?>][title_bigimages_pos]">
                                                                                                    <option value="right" <?php if ( $cat['title_bigimages_pos'] == 'right') { echo ' selected="selected"' ; } ?>>Right</option>
                                                                                                    <option value="left" <?php if ( $cat['title_bigimages_pos'] == 'left') { echo ' selected="selected"' ; } ?>>Left</option>
                                                                                            </select>
                                                                                        </label>
                                                                                        
                                                                                        <label for="tie_home_cats[<?php echo $i ?>][title_img]"><span>Show Title images or text:</span>
												<select id="tie_home_cats[<?php echo $i ?>][title_img]" name="tie_home_cats[<?php echo $i ?>][title_img]">
													<option value="n" <?php if ( $cat['title_img'] == 'n') { echo ' selected="selected"' ; } ?>>No</option>
													<option value="y" <?php if ( $cat['title_img'] == 'y') { echo ' selected="selected"' ; } ?>>Yes</option>
												</select>
											</label>
                                                                                        <label for="tie_home_cats[<?php echo $i ?>][title_style]"><span>Show Title style color:</span>
												<select id="tie_home_cats[<?php echo $i ?>][title_style]" name="tie_home_cats[<?php echo $i ?>][title_style]">
													<option value="title_product1" <?php if ( $cat['title_style'] == 'title_product1') { echo ' selected="selected"' ; } ?>>Title style color product1</option>
													<option value="title_product2" <?php if ( $cat['title_style'] == 'title_product2') { echo ' selected="selected"' ; } ?>>Title style color product2</option>
                                                                                                        <option value="title_product3" <?php if ( $cat['title_style'] == 'title_product3') { echo ' selected="selected"' ; } ?>>Title style color product3</option>
                                                                                                        <option value="title_product4" <?php if ( $cat['title_style'] == 'title_product4') { echo ' selected="selected"' ; } ?>>Title style color product4</option>
                                                                                                        <option value="title_product5" <?php if ( $cat['title_style'] == 'title_product5') { echo ' selected="selected"' ; } ?>>Title style color product5</option>
												</select>
											</label>
                                                                                        <label for="tie_home_cats[<?php echo $i ?>][title_url]"><span>Box Title Url :</span><input id="tie_home_cats[<?php echo $i ?>][title_url]" name="tie_home_cats[<?php echo $i ?>][title_url]" value="<?php   if( !empty($cat['title_url']) ) echo $cat['title_url']  ?>" type="text" /></label>
		...
		<div id="tab7" class="tabs-wrap">
			...
			<div class="tiepanel-item">
				...
				<h3>Keywords footer Tag cloud</h3>
				<?php
					tie_options(
						array(	"name" => "Display Or Off Keywords footer",
								"id" => "keywords_footer",
								"type" => "checkbox"));
				?>
                                ...
                                tie_options(			
						array(	"name" => "Logo register footer",
								"id" => "logo_register_footer",
								"type" => "upload")); 
			...
			<div class="tiepanel-item">
				...
				<div class="option-item">
					...
					<span style="padding-left:0" class="extra-text"><strong style="font-size: 12px;">Variables</strong>
                        ...
                        <div class="tiepanel-item">
				<h3>Footer Menu Buyer</h3>
				<div class="option-item">
                                    <?php 
                                    tie_options(
						array(	"name" => "Display Or Off Footer Menu Buyer",
								"id" => "footer-menu-buyer",
								"type" => "checkbox"));
                                    
                                    tie_options(
						array(	"name" => "Display Or Off Footer Menu Seller",
								"id" => "footer-menu-seller",
								"type" => "checkbox"));
                                    
                                    ?>
                                    
                                    <strong>Edit menu Footer menu </strong> : <em><a href="<?php bloginfo('url');?>/wp-admin/nav-menus.php">Click edit</a></em><br />
				</div>
			</div>
		...
		<div id="tab8" class="tab_content tabs-wrap">
			...
			<div class="tiepanel-item">
				...
				?>
                        ...
                        <div class="tiepanel-item">
				<h3>Home Banner Area right slide show</h3>
				<?php
					tie_options(				
						array(	"name" => "Home Banner right slider",
								"id" => "home_banner_right_slider",
								"type" => "checkbox")); 
				?>
				<div class="tie-accordion">
					<h4 class="accordion-head"><a href="">Image Banner right 1</a></h4>
					<div class="tie-accordion-contnet">
                                        <?php
                                                tie_options(			
                                                        array(	"name" => "Home Banner right slider1",
                                                                        "id" => "home_banner_right_slider_img1",
                                                                        "type" => "upload")); 

                                                tie_options(					
                                                        array(	"name" => "Home Banner right slider1 Link",
                                                                        "id" => "home_banner_right_slider_url1",
                                                                        "type" => "text")); 

                                                tie_options(				
                                                        array(	"name" => "Alternative Text For The image",
                                                                        "id" => "home_banner_right_slider_alt1",
                                                                        "type" => "text"));

                                                tie_options(
                                                        array(	"name" => "Open The Link In a new Tab",
                                                                        "id" => "home_banner_right_slider_tab1",
                                                                        "type" => "checkbox"));

                                                tie_options(
                                                        array(	"name" => "Nofollow",
                                                                        "id" => "home_banner_right_slider_nofollow1",
                                                                        "type" => "checkbox"));
                                        ?>
					</div>
						
                                        <h4 class="accordion-head"><a href="">Image Banner right 2</a></h4>
					<div class="tie-accordion-contnet">
                                        <?php
                                                tie_options(			
                                                        array(	"name" => "Home Banner right slider2",
                                                                        "id" => "home_banner_right_slider_img2",
                                                                        "type" => "upload")); 

                                                tie_options(					
                                                        array(	"name" => "Home Banner right slider2 Link",
                                                                        "id" => "home_banner_right_slider_url2",
                                                                        "type" => "text")); 

                                                tie_options(				
                                                        array(	"name" => "Alternative Text For The image",
                                                                        "id" => "home_banner_right_slider_alt2",
                                                                        "type" => "text"));

                                                tie_options(
                                                        array(	"name" => "Open The Link In a new Tab",
                                                                        "id" => "home_banner_right_slider_tab2",
                                                                        "type" => "checkbox"));

                                                tie_options(
                                                        array(	"name" => "Nofollow",
                                                                        "id" => "home_banner_right_slider_nofollow2",
                                                                        "type" => "checkbox"));
                                        ?>
					</div>
                                        
                                        <h4 class="accordion-head"><a href="">Image Banner right 3</a></h4>
					<div class="tie-accordion-contnet">
                                        <?php
                                                tie_options(			
                                                        array(	"name" => "Home Banner right slider3",
                                                                        "id" => "home_banner_right_slider_img3",
                                                                        "type" => "upload")); 

                                                tie_options(					
                                                        array(	"name" => "Home Banner right slider3 Link",
                                                                        "id" => "home_banner_right_slider_url3",
                                                                        "type" => "text")); 

                                                tie_options(				
                                                        array(	"name" => "Alternative Text For The image",
                                                                        "id" => "home_banner_right_slider_alt3",
                                                                        "type" => "text"));

                                                tie_options(
                                                        array(	"name" => "Open The Link In a new Tab",
                                                                        "id" => "home_banner_right_slider_tab3",
                                                                        "type" => "checkbox"));

                                                tie_options(
                                                        array(	"name" => "Nofollow",
                                                                        "id" => "home_banner_right_slider_nofollow3",
                                                                        "type" => "checkbox"));
                                        ?>
					</div>
		...
		<div id="tab10" class="tab_content tabs-wrap">
				...
				<?php
					tie_options(
						array(	"name" => "TimThumb <small style='font-weight:bold;'>(Not Recommended)</small>",
								...
								"type" => "checkbox"));
                                        tie_options(
						array(	"name" => "Lazy loadding <small style='font-weight:bold;'>(Not Recommended)</small>",
								"id" => "lazyload",
								"type" => "checkbox"));
				?>
			</div>	
			...
			<h2>Shop Settings</h2>	<?php echo $save ?>	

			<div class="tiepanel-item">
				<h3>Shop Setting Display</h3>
				<?php
					tie_options(
						array(	"name" => "Shop Setting display",
								"id" => "shop_setting_display",
								"type" => "checkbox"));
				?>
			...
			<h2>Newsletter Settings</h2>	<?php echo $save ?>	

			<div class="tiepanel-item">
				<h3>Newsletter Setting Display</h3>
				<?php
					tie_options(
						array(	"name" => "Newsletter Setting display",
								"id" => "newsletter_setting_display",
								"type" => "checkbox"));
				?>
                 ...
                 <!-- Mobile setting -->
                <div id="tab17" class="tab_content tabs-wrap">
			<h2>Mobile Settings</h2>	<?php echo $save ?>	

			<div class="tiepanel-item">
				<h3>Mobile Setting Display</h3>
				<?php
					tie_options(
						array(	"name" => "Mobile setting display",
								"id" => "mobile_seting_display",
								"type" => "checkbox"));
				?>
