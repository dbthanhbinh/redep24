var scrolltotop={
	...
	controlHTML: '<img src="imgs/layout/back_to_top.png" style="width:50px; height:50px; position:relative; z-index:999;" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
