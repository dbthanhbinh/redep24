			...
			echo '<form method="post" action="options.php" enctype="multipart/form-data" id="nhp-opts-form-wrapper">';
				...
				echo '<div id="nhp-opts-sidebar">';
					echo '<ul id="nhp-opts-group-menu">';
						...
						// menu home page add more
						
							echo '<li id="db_home_page_default_section_group_li" class="nhp-opts-group-tab-link-li">';
							echo '<a href="javascript:void(0);" id="db_home_page_default_section_group_li_a" class="nhp-opts-group-tab-link-a" data-rel="db_home_page_default"><img src="'.$this->url.'img/glyphicons/glyphicons_082_roundabout.png" /> <span>'.__('Custom Home page', 'nhp-opts').'</span></a>';
							echo '</li>';
				...
				echo '<div id="nhp-opts-main">';
					...
					if(true === $this->args['show_import_export']){
						echo '<div id="import_export_default_section_group'.'" class="nhp-opts-group-tab">';
							...
							echo '<p id="nhp-opts-import-action"><input type="submit" id="nhp-opts-import" name="'.$this->args['opt_name'].'[import]" class="button-primary" value="'.__('Import', 'nhp-opts').'"> <span>'.apply_filters('nhp-opts-import-warning', __('Any existing settings will be overwritten, please proceed with caution!', 'nhp-opts')).'</span></p>';
							echo '<div id="import_divide"></div>';
							
							echo '<h4>'.__('Export Options', 'nhp-opts').'</h4>';
							echo '<div class="nhp-opts-section-desc">';
								echo '<p class="description">'.apply_filters('nhp-opts-backup-description', __('Here you can copy or download your current theme settings. Keep them in a safe place. Should anything go wrong, you can use them to restore your settings on this site (or any other site with the same theme). A handy option of copying the link with current theme settings is also available. ', 'nhp-opts')).'</p>';
							echo '</div>';
					...
					//// customer home page
					if(true === $this->args['show_import_export']){
						echo '<div id="db_home_page_default_section_group'.'" class="nhp-opts-group-tab">';
						echo '<h3>'.__('Tùy chỉnh sản phẩm trang chủ và bán chạy', 'nhp-opts').'</h3>';
						
						echo '<div class="db_left-options" style="float:left; width:90%;">';
								
								
								echo '								
								<h4> Campain trang chủ theo thứ tự trái->phải + Trên dưới (Dưới sản phẩm bán chạy)</h4>
								<hr/>	
								
								<p style="display:inline-block; width:100%;">
									<label style="width:30%;">Hình ad 1 (606x312 px)</label>		
									<input type="text" style="float:left;" name="basic[myhome_campain1_img]" value="'.$this->options['myhome_campain1_img'].'" />
									
									<label style="width:100px; margin-left:10px;">Link liên kết</label>		
									<input type="text" name="basic[myhome_campain1_link]" value="'.$this->options['myhome_campain1_link'].'" />
									
								</p>	
								<p style="display:inline-block; width:100%;">
									<label style="width:30%;">Hình ad 2 (606x312 px)</label>		
									<input type="text" style="float:left;" name="basic[myhome_campain2_img]" value="'.$this->options['myhome_campain2_img'].'" />
									
									<label style="width:100px; margin-left:10px;">Link liên kết</label>		
									<input type="text" name="basic[myhome_campain2_link]" value="'.$this->options['myhome_campain2_link'].'" />
                                                                ...
                                                                <hr/>
                                                                <p style="display:inline-block; width:100%;">
									<label style="width:30%;">Số sản phẩm hiển thị Best seller</label>		
									<input type="text" style="float:left;" name="basic[myhome_number_best_seller]" value="'.$this->options['myhome_number_best_seller'].'" />
								</p>
